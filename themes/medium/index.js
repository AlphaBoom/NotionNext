...
const LayoutBase = props => {
  ...
  return (
        <ThemeGlobalMedium.Provider value={{ tocVisible, changeTocVisible }}>
            ...
            <div id='theme-medium' className='bg-day dark:bg-hexo-black-gray w-full h-full min-h-screen justify-center dark:text-gray-300'>
                ...
                <main id='wrapper' className={(JSON.parse(siteConfig('LAYOUT_SIDEBAR_REVERSE')) ? 'flex-row-reverse' : '') + 'relative flex justify-between w-full h-full mx-auto'}>
                    ...
                    {fullWidth
                      ? null
                      : <div className={`bg-slate-50 dark:bg-transparent  hidden xl:block border-l dark:border-transparent w-96 relative z-10 ${siteConfig('MEDIUM_RIGHT_PANEL_DARK', null, CONFIG) ? 'bg-hexo-black-gray dark' : ''}`}>
