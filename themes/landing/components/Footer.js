                                ...
                                <div className="flex flex-wrap mb-4">
                                    <div className="w-full">
                                        ...
                                        <div className="relative flex items-center max-w-xs">
                                            <input name="email" disabled={disabled} id="newsletter" type="email" className="form-input w-full text-gray-800 px-3 py-2 pr-12 text-sm" placeholder="Your email" required />
