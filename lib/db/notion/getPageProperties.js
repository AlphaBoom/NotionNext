...
import { normalizeWritingMode } from '@/lib/utils/writingMode.mjs'
...
export default async function getPageProperties(
  ...
  properties.writingMode = normalizeWritingMode(properties.writingMode)
  properties.aiSummary = typeof properties.aiSummary === 'string' ? properties.aiSummary.trim() : ''
