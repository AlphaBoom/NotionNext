...
import { getWritingModeSummary, prependWritingModeNotice } from './writingMode.mjs'
...
const createFeedContent = async post => {
  ...
  if (post.password && post.password !== '') {
    return getWritingModeSummary(post)
  }
  ...
  if (blockMap) {
    ...
    return prependWritingModeNotice(content.replace(regexExp, ''), post.writingMode)
  }
}
