...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '32c16f6bb85e4e949eba49dee2d73a5c',
  PSEUDO_STATIC: process.env.NEXT_PUBLIC_PSEUDO_STATIC || false, // 伪静态路径，开启后所有文章URL都以 .html 结尾。
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 600, // ISR 缓存期（秒），默认 10 分钟；过期后的访问触发后台更新，减少重复生成与写入。可通过环境变量或 Notion 配置覆盖。
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'AlphaBoom', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '简单写写', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion.alphaboom.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AlphaBoom,博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: '', // 不提供邮件联系入口
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/AlphaBoom', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo-alphaboom.vercel.app/', // TWIKOO地址 腾讯云环境填 envId；Vercel 环境域名地址（https://xxx.vercel.app)
  ...
  AOS_ENABLE: process.env.NEXT_PUBLIC_AOS_ENABLE || false, // 是否加载 AOS 滚动动画
