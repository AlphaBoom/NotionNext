...
import SecretSurvivors from '@/themes/medium/reward/components/SecretSurvivors'
import {
  beginLeaderboardRun,
  submitLeaderboardRun
} from '@/themes/medium/reward/lib/survivorsLeaderboard'
import { stepRun } from '@/themes/medium/reward/lib/survivors'

jest.mock('@/themes/medium/reward/lib/survivorsLeaderboard', () => ({
  ...jest.requireActual('@/themes/medium/reward/lib/survivorsLeaderboard'),
...
jest.mock('@/themes/medium/reward/lib/survivors', () => ({
  ...jest.requireActual('@/themes/medium/reward/lib/survivors'),
  stepRun: jest.fn()
}))
jest.mock('@/themes/medium/reward/lib/survivorsCanvas', () => ({
