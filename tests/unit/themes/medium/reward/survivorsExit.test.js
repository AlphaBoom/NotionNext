...
import { createRun } from '@/themes/medium/reward/lib/survivors'
import { offerUpgrades } from '@/themes/medium/reward/lib/survivors'
import { createRenderer } from '@/themes/medium/reward/lib/survivorsCanvas'
...
const actualCreateRun = jest.requireActual(
  '@/themes/medium/reward/lib/survivors'
).createRun
