...
import RewardProvider, {
  useReward
} from '@/themes/medium/reward/components/RewardProvider'
import { prepareArtwork } from '@/themes/medium/reward/components/NewGameTheme'
import { REWARD_KEY, readReward } from '@/themes/medium/reward/lib/rewardState'
import { useVictoryReveal } from '@/themes/medium/reward/lib/useVictoryReveal'

jest.mock('@/themes/medium/reward/components/NewGameTheme', () => ({
  ...jest.requireActual('@/themes/medium/reward/components/NewGameTheme'),
  __esModule: true,
...
jest.mock('@/themes/medium/reward/components/RewardPlayground', () => () => null)
jest.mock(
  '@/themes/medium/reward/components/RewardContextMenu',
  () =>
