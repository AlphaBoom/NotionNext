...
import SecretRunner from '@/themes/medium/reward/components/SecretRunner'
import { createRunner } from '@/themes/medium/reward/lib/hedgehogRunner'

jest.mock('@/themes/medium/reward/lib/hedgehogRunner', () => ({
  ...jest.requireActual('@/themes/medium/reward/lib/hedgehogRunner'),
  createRunner: jest.fn()
}))
const actualCreate = jest.requireActual(
  '@/themes/medium/reward/lib/hedgehogRunner'
).createRunner
const originals = {
