...
jest.mock('@/themes/medium/reward/components/SecretSurvivors', () => {
  mockDesktopLoad()
  return {
    __esModule: true,
    default: ({ onClose }) => (
...
jest.mock('@/themes/medium/reward/components/SecretRunner', () => {
  mockMobileLoad()
  return {
    __esModule: true,
...
jest.mock('@/themes/medium/reward/components/RewardProvider', () => ({
