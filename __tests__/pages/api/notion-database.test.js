...
import { DatabaseError, getDatabasePreview } from '@/lib/notion/database/server'
jest.mock('notion-client', () => ({ NotionAPI: jest.fn(() => ({})) }))
jest.mock('@/lib/notion/database/server', () => ({
  ...jest.requireActual('@/lib/notion/database/server'),
